// Ported directly from title-crm/src/theme.ts — same five themes, same CSS-variable
// approach, just renamed the localStorage key so it doesn't collide with title-crm
// if both apps ever run on the same machine/profile.
...
const STORAGE_KEY = 'chscrm_theme';
